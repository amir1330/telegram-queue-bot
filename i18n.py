...
STRINGS = {
    "en": {
        ...
        "prompt_header": "Enter any text for under the lesson line (or - to clear).\nMentions OK: [Name](tg://user?id=123) or [Name](tg://resolve?domain=user)",
    ...
    "ru": {
        ...
        "prompt_header": "Введите любой текст под строкой урока (или - чтобы убрать).\nУпоминания ОК: [Имя](tg://user?id=123) или [Имя](tg://resolve?domain=user)",
