...
STRINGS = {
    "en": {
        ...
        "prompt_before": "Enter minutes (just type e.g. 30 or Monday 30, or Reply):",
        "prompt_duration": "Enter minutes (just type e.g. 30 or Monday 30, or Reply):",
    ...
    "ru": {
        ...
        "prompt_before": "Введите минуты (просто напишите, например 30 или Понедельник 30, или Reply):",
        "prompt_duration": "Введите минуты (просто напишите, например 30 или Понедельник 30, или Reply):",
