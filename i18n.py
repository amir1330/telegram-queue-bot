...
STRINGS = {
    "en": {
        ...
        # on-demand Jitsi room (/meet)
        "admin_meet": "open an on-demand video room (5 min joins)",
        "admin_endmeet": "force-close the active video room",
        "meet_active": "A room is already active.",
        "meet_posted": "Room open for 5 minutes. Tap Join below.",
        "meet_join_btn": "Join lesson",
        "meet_open_btn": "Open call",
        "meet_closed": "The room is closed.",
        "meet_expired": "This link has expired.",
        "meet_not_member": "You must be a member of the group to join.",
        "meet_dm": "Your personal link (valid a bit over 5 min):",
        "meet_unconfigured": "Video calls are not configured on this bot yet.",
        "meet_ended": "Room closed.",
        # owner personal rooms (/room, DM only)
        "room_mod_btn": "Open as moderator",
        "room_guest_btn": "Guest link (share this)",
        "room_text": "Room <b>{room}</b>.\nModerator link is valid 8h, guest link 3h.",
        # scheduled questions (/setask)
        "admin_setask": "schedule a question with answers (day, time, options)",
        "admin_asks": "list this chat's scheduled questions",
        "admin_delask": "delete a scheduled question",
        "admin_askduration": "how long answers stay open (minutes)",
        "admin_askpost": "post a scheduled question now (testing)",
        "usage_setask": "Usage: /setask <Day> <HH:MM> | <question> | <opt1> | <opt2> | ...\nExample: /setask Monday 12:00 | Are you coming Mon 18:00? | Yes | No | ?I have a reason\nA leading ? means answering requires a reason.",
        "prompt_setask_day": "Choose a day of the week:",
        "prompt_setask_time": "Enter time HH:MM (just type e.g. 12:00, or Reply to this):",
        "prompt_setask_question": "Enter the question text (or Reply to this):",
        "prompt_setask_options": "Enter options separated by | (leading ? = needs a reason):",
        "setask_day_picked": "Day: {day}. Now enter the time.",
        "setask_saved": "Question #{id} saved: {day} {time}.",
        "setask_empty": "No scheduled questions. Add one with /setask.",
        "setask_list_line": "#{id} {day} {time} ({dur} min): {text}",
        "setask_deleted": "Question #{id} deleted.",
        "setask_no_id": "No question #{id} in this chat.",
        "usage_delask": "Usage: /delask <id>",
        "usage_askduration": "Usage: /askduration [id] <minutes>\nExample: /askduration 360 or /askduration 3 60",
        "askduration_set": "Question #{id}: answers stay open {value} min.",
        "askduration_bad": "Minutes must be between 1 and 1440.",
        "usage_askpost": "Usage: /askpost <id>",
        "ask_closed": "Answers are closed.",
        "ask_reason_prompt": "{name}, reply with your reason (or Reply to this):",
    ...
    "ru": {
        ...
        # on-demand Jitsi room (/meet)
        "admin_meet": "открыть видео-комнату на лету (вход 5 мин)",
        "admin_endmeet": "принудительно закрыть активную комнату",
        "meet_active": "Комната уже активна.",
        "meet_posted": "Комната открыта 5 минут. Нажми Join ниже.",
        "meet_join_btn": "Join lesson",
        "meet_open_btn": "Открыть звонок",
        "meet_closed": "Комната закрыта.",
        "meet_expired": "Ссылка истекла.",
        "meet_not_member": "Нужно быть участником группы, чтобы войти.",
        "meet_dm": "Твоя личная ссылка (действует чуть больше 5 мин):",
        "meet_unconfigured": "Видеозвонки на этом боте ещё не настроены.",
        "meet_ended": "Комната закрыта.",
        # owner personal rooms (/room, DM only)
        "room_mod_btn": "Открыть как модератор",
        "room_guest_btn": "Гостевая ссылка (поделись ей)",
        "room_text": "Комната <b>{room}</b>.\nСсылка модератора — 8 ч, гостевая — 3 ч.",
        # scheduled questions (/setask)
        "admin_setask": "запланировать вопрос с ответами (день, время, варианты)",
        "admin_asks": "список запланированных вопросов",
        "admin_delask": "удалить запланированный вопрос",
        "admin_askduration": "сколько минут открыты ответы",
        "admin_askpost": "опубликовать вопрос сейчас (тест)",
        "usage_setask": "Использование: /setask <День> <ЧЧ:ММ> | <вопрос> | <вариант1> | <вариант2> | ...\nПример: /setask Понедельник 12:00 | Придёшь в пн 18:00? | Да | Нет | ?Есть причина\nВедущий ? — ответ требует причину.",
        "prompt_setask_day": "Выберите день недели:",
        "prompt_setask_time": "Введите время ЧЧ:ММ (просто напишите, например 12:00, или Reply):",
        "prompt_setask_question": "Введите текст вопроса (или Reply):",
        "prompt_setask_options": "Введите варианты через | (ведущий ? = нужна причина):",
        "setask_day_picked": "День: {day}. Теперь введите время.",
        "setask_saved": "Вопрос #{id} сохранён: {day} {time}.",
        "setask_empty": "Нет запланированных вопросов. Добавьте командой /setask.",
        "setask_list_line": "#{id} {day} {time} ({dur} мин): {text}",
        "setask_deleted": "Вопрос #{id} удалён.",
        "setask_no_id": "Нет вопроса #{id} в этом чате.",
        "usage_delask": "Использование: /delask <id>",
        "usage_askduration": "Использование: /askduration [id] <минуты>\nПример: /askduration 360 или /askduration 3 60",
        "askduration_set": "Вопрос #{id}: ответы открыты {value} мин.",
        "askduration_bad": "Минуты должны быть от 1 до 1440.",
        "usage_askpost": "Использование: /askpost <id>",
        "ask_closed": "Ответы закрыты.",
        "ask_reason_prompt": "{name}, ответь причиной (или Reply):",
