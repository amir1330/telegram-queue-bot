...
STRINGS = {
    "en": {
        ...
        "lesson_set": "Lesson set: {lesson}\nQueue opens while the admin sets /before and /duration.",
    ...
    "ru": {
        ...
        "lesson_set": "Урок задан: {lesson}\nОчередь открывается по настройкам /before и /duration.",
