...
STRINGS = {
    "en": {
        ...
        "usage_timer": "Usage: /timer [day] <seconds>\nExample: /timer 300 or /timer Monday 300",
        "prompt_timer_day": "Choose a lesson to set timer:",
        "prompt_timer": "Enter timer seconds (e.g. 300):",
    ...
    "ru": {
        ...
        "usage_timer": "Использование: /timer [день] <секунды>\nПример: /timer 300 или /timer Понедельник 300",
        "prompt_timer_day": "Выберите урок — для какого задать таймер:",
        "prompt_timer": "Введите секунды таймера (например 300):",
