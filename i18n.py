...
STRINGS = {
    "en": {
        ...
        "admin_header": "custom text under the lesson line in the queue",
        ...
        "prompt_header": "Enter people/notes under the lesson line (or - to clear).\nPaste mentions normally, or wrap markdown in ``` so links stay intact.",
    ...
    "ru": {
        ...
        "admin_header": "свой текст под строкой урока в очереди",
